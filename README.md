...
#### In this repository you will be able to see an example of SVELTE where you will be able to write by means of your keyboard a sentence, to later generate a list in which you can eliminate the finished task. 

*REMEMBER
 That you will need to have Node.js installed. Also install the git application,
...
### 03. To see the changes of your programming in real time and then start [Rollup](https://rollupjs.org):
